    ...
    <div className="p-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-800 mb-2">
                    <strong>Enunciado:</strong> {variation.content.substring(0, 200)}
                    {variation.content.length > 200 && '...'}
                  </div>
                  <div className="text-xs text-gray-500">
                    <strong>ID:</strong> {variation.id} | 
                    <strong> Alternativas:</strong> {variation.alternatives.length} | 
                    <strong> Especialidad:</strong> {variation.specialty}
                  </div>
                </div>
              </div>
            </div>
      ...
      {variations.length === 0 && !loading && (
        <div className="text-center py-8 text-gray-500">
          No se encontraron variaciones con los filtros aplicados.
        </div>
      )}
    </div>
  );
